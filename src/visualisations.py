...
def create_visualizations(data):
    ...
    plt.savefig(
        reports_path / f"customer_distribution.png"
    )
    ...
    plt.savefig(
        reports_path / f"revenue_by_type.png"
    )
    ...
    plt.savefig(
        reports_path / f"payment_status.png"
    )
    ...
    plt.savefig(
        reports_path / f"usage_distribution.png"
    )
    ...
    plt.savefig(
        reports_path / f"paid_vs_pending_revenue.png"
    )
    ...
    plt.savefig(
        reports_path / f"finance_overview.png"
    )
    ...
    plt.savefig(
        reports_path / f"revenue_share.png"
    )
    ...
    plt.savefig(
        reports_path / f"units_vs_bill.png"
    )
    ...
    plt.savefig(
        reports_path / f"top_5_customers.png"
    )
